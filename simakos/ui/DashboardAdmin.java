...
public class DashboardAdmin extends javax.swing.JFrame {
     ...
     */
    public DashboardAdmin(int adminId, String username) {
        initComponents();
        
        this.currentAdminId = adminId;
        this.usernameAdmin = username;
        
        //String sql = "SELECT username FROM admin WHERE id_admin = "+ this.usernameAdmin;
        
        txtNamaAkun.setText(this.usernameAdmin);
    ...
    private void loadDashboardData(){
        int jumlahKamar = kamarService.getTotalKamarCount();
        txtJumlahKamar.setText(String.valueOf(jumlahKamar));
    }
    ...
    private void initComponents() {
        ...
        txtNamaAkun = new javax.swing.JLabel();
        ...
        jPanel3.setBackground(new java.awt.Color(164, 10, 146));
        ...
        txtNamaAkun.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        txtNamaAkun.setText("Admin");

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel4.setText("Status Pembayaran Penyewa");
    ...
    private javax.swing.JLabel txtNamaAkun;
